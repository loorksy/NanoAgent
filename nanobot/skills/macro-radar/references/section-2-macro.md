# Spec section 2 — Macro radar

Table of contents: `S2.1` Calendar · `S2.2` DXY · `S2.3` Tone · `S2.4` Geopolitics

### S2.1 — Live economic calendar
...
### S2.4 — Geopolitical safe-haven radar
