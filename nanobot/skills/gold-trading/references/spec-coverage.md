...
| P-184 | DETERMINISTIC | DETERMINISTIC — max positions losing-side check / `evaluate_no_martingale` | `nanobot/trading/gates/max_positions.py` `evaluate_no_martingale` `tests/trading/test_risk_gates.py::test_no_martingale` | invoked from recommendation path; invoked from MT5 execution path |
