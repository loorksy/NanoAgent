...
- **Kind:** DETERMINISTIC — G12 / `DAILY_DRAWDOWN_PCT`
...
- **Kind:** DETERMINISTIC — G14 / `HALF_DISTANCE_FRACTION`
...
- **Kind:** DETERMINISTIC — G15 / `DAILY_CLOSE_LOCK_MINUTES`
